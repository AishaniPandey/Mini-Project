...
class oilseeds extends StatelessWidget {
  const oilseeds({Key? key}) : super(key: key);
      ...
      child: ListView(
        children: <Widget>[
          ...
          Padding(
            padding: const EdgeInsets.all(5),
            //padding: EdgeInsets.symmetric(horizontal: 15),
            child: Text("Oil seeds",style: new TextStyle(fontSize: 15.0)),
          ),
          Padding(
            padding: const EdgeInsets.all(5),
            //padding: EdgeInsets.symmetric(horizontal: 15),
          ...
          Padding(
            padding: const EdgeInsets.all(5),
            //padding: EdgeInsets.symmetric(horizontal: 15),
            child: Text("9 ppm:7:30",style: new TextStyle(fontSize: 15.0)),
          ...
          Padding(
            padding: const EdgeInsets.all(5),
            //padding: EdgeInsets.symmetric(horizontal: 15),
            child: Text(" 29c",style: new TextStyle(fontSize: 15.0)),
          ...
          Padding(
            padding: const EdgeInsets.all(5),
            //padding: EdgeInsets.symmetric(horizontal: 15),
            child: Text("58 gm/cm3",style: new TextStyle(fontSize: 15.0)),
